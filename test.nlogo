...
to setup
  ...
  create-nucleous 1
  create-electrons 17
  let x (turtle-set turtle 1 turtle 2 turtle 3 turtle 4 turtle 5 turtle 6 turtle 7 turtle 8 turtle 9 turtle 10 turtle 11 turtle 12 turtle 13 turtle 14 turtle 15 turtle 16 turtle 17 turtle 18)
  layout-circle x 1
  ask x [create-link-with turtle 0] 
  ;H 
  create-nucleous 1
  create-electrons 1
  ;let y (turtle-set turtle 19)
  ask turtle 18 [create-link-with turtle 19]
  reset-ticks
end
...
to go
  ask turtles [
 if(breed = nucleous)[
   let randx random-float 10 - random-float 10
   let randy random-float 10 - random-float 10
   setxy randx randy 
   ask link-neighbors [
     setxy randx + (random-float 1 - random-float 1) randy + (random-float 1 - random-float 1)
     ask link-neighbors [
       setxy randx + (random-float 1 - random-float 1) randy + (random-float 1 - random-float 1)
     ]
   ]
   ;layout-circle link-neighbors 1
  ]
  ]
  ask turtles  [
   if(breed = nucleous)[
     ...
     let curwho who
     let countMod count link-neighbors 
     if(countMod mod 8 != 0)[
       ask other turtles [
         if(breed = nucleous and count [link-neighbors] of turtle who mod 8 != 0)[
                ask turtle who [create-link-with turtle curwho]
